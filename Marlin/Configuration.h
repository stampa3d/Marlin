...
#define STRING_CONFIG_H_AUTHOR "(REALITY3D, GTR SIRIUS)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 382.165 } //ESTRUSORE BMG EXTRUDER
