...
#define STRING_CONFIG_H_AUTHOR "(3d REALITY, BUGX 8 GTR)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 382.165 } //PER BMG EXTRUDER
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.37, 6.86, -3.46 }
...
#define HOMING_FEEDRATE_MM_M { (30*60), (50*60), (4*60) } //per tmc2209 metti 30
...
//
// Host Keepalive DISABILITATE MESSAGGI DI "OCCUPATO"
//
